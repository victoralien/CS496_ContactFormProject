document.getElementById('contact-form').addEventListener('submit', function(event) {
  ...
  function submitForm(formData) {
    ...
    fetch('https://0c4c574itg.execute-api.us-east-1.amazonaws.com/dev/submit', { // URL that represents the backend API endpoint to which the form data is going to be sent
      method: 'POST',
      headers: {
